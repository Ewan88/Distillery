...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Whisky> whiskyFromDistilleryByAge = whiskyRepository.getWhiskyFromDistilleryByAge("Glendronach", 15);

        List<Whisky> whiskyFromRegion = whiskyRepository.getWhiskyFromRegion("Highland");

        List<Distillery> distilleriesWith12YearOldWhisky = distilleryRepository.getDistilleriesWith12YearOldWhisky();
